    ...
    <div class="container">
      ...
      if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            $sql1 = "SELECT * FROM cases WHERE caseid=(SELECT caseid from client_con WHERE clientid=$clientid)";
          ...
          <div class="card mb-4 shadow-sm">
            ...
            <p class="card-text">'.$row['clientage'].'&nbsp;&nbsp;<code>'.$row['clientgender'].'</code></p>
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="../dashboard/cases.php?id='.$caseid.'"><p class="card-text"><i>'.$row1['party1'].' vs '.$row1['party2'].'</i></p></a>
